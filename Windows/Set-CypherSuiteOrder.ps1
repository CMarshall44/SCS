...
#https://techcommunity.microsoft.com/blog/microsoft-security-blog/support-for-legacy-tls-protocols-and-cipher-suites-in-azure-offerings/

      $cipherSuitesOrder = @(
       'TLS_CHACHA20_POLY1305_SHA256', #TLS 1.3 for non microsoft
